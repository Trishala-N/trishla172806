...
class Account :
   ...
   def createemployee(self):      
       ...
       print('\n')
       salary_calculation()
       self.salary = int(input("Enter the calculated salary: "))       
       print('\n')       
...
def displayAll():
   ...
   if file.exists ():
       ...
       if (len(mylist)!=0):
          ...
          label1=Label(root,text="THE LIST OF ALL EMPLOYEES")
          label1.config(font=('TIMES NEW ROMAN',20,), justify=CENTER, background="PINK",fg="RED", anchor="center")
          label1.pack(fill=X)
...
def welcome():
   ...
   label1.config(font=('times new roman',5,'bold'), justify=CENTER, background="light green",fg="Yellow", anchor="center")
   label1.pack(fill=X)
   #label 2 empty line
   label1=Label(root,text="")
   label1.config(font=('times new roman',5,'bold'), justify=CENTER, background="light green",fg="Yellow", anchor="center")
   ...
   label1.config(font=('times new roman',15,'bold'), justify=CENTER, background="light green",fg="black", anchor="nw")
   label1.pack(fill=X)
   #label 17 school name
   label1=Label(root,text="SCHOOL : GURU SHREE SHANTIVIJAI JAIN VIDYALAY ")
   label1.config(font=('times new roman',15,'bold'), justify=CENTER, background="light green",fg="black", anchor="nw")
   label1.pack(fill=X)
   ...
   f.configure(background="light green")
   f.pack()
...
def menu():
    ...
    root.configure(background="light green")
    label1=Label(root,text="")
    label1.config(font=('times new roman',12,'bold'), justify=CENTER, background="light green",fg="WHITE", anchor="nw")
    label1.pack(fill=X)
    label1=Label(root,text="")
    label1.config(font=('times new roman',12,'bold'), justify=CENTER, background="light green",fg="WHITE", anchor="nw")
    label1.pack(fill=X)
    ...
    label1.config(font=('times new roman',16,'bold'), justify=CENTER, background="white",fg="light green", anchor="center")
    label1.pack(fill=X)
    #label 2 empty line
    label1=Label(root,text="")
    label1.config(font=('times new roman',12,'bold'), justify=CENTER, background="light green",fg="WHITE", anchor="nw")
    ...
    label1.config(font=('times new roman',12,'bold'), justify=CENTER, background="light green",fg="WHITE", anchor="nw")
    label1.pack(fill=X)
    #label 19 from the above listed option select one
    label1=Label(root,text="SELECT YOUR CHOICE")
    label1.config(font=('times new roman',16,'bold'), justify=CENTER, background="light green",fg="light green", anchor="sw")
    label1.pack(fill=X)
    #label 20 empty line
    label1=Label(root,text="")
    label1.config(font=('times new roman',12,'bold'), justify=CENTER, background="light green",fg="light green", anchor="nw")
    label1.pack(fill=X)
    #button 1
...
def show_entry_fields():
    ...
    if(e1.get()=="Gssjv" and e2.get()=="gssjv@localhost"):
...
label1.config(font=('TIMES NEW ROMAN',20,'bold','underline'), justify=CENTER, background="pink",fg="RED", anchor="center")
label1.pack(fill=X)
